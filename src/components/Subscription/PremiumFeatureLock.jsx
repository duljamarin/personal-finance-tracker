...
export default function PremiumFeatureLock({ children, featureName }) {
  ...
  return (
    <div className="relative">
      ...
      {/* Lock overlay */}
      <div className="absolute inset-0 flex items-center justify-center bg-white/85 dark:bg-gray-900/70 backdrop-blur-[2px] rounded-xl">
        <div className="text-center p-6 max-w-sm bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-700 mx-4">
