...
export default function NotificationsPage() {
  ...
  const getNotificationIcon = (type) => {
    switch (type) {
      case 'budget_overrun':
        return (
          <div className="w-10 h-10 rounded-full flex items-center justify-center bg-expense-tint">
      ...
      case 'trial_expiring':
        return (
          <div className="w-10 h-10 bg-warning-bg dark:bg-warning/15 rounded-full flex items-center justify-center">
