      ...
      return (
        <div className="min-h-[50vh] flex items-center justify-center p-6">
          <div className="text-center max-w-md">
            ...
            <h2 className="font-display font-semibold tracking-tight text-xl text-ink-primary dark:text-ink-dark-primary mb-2">
              Something went wrong
            </h2>
            <p className="text-ink-muted dark:text-ink-dark-muted mb-6">
