      ...
      <Card className="mb-6" padding="none">
        <div className="p-4 sm:p-5">
          <div className="animate-pulse space-y-3">
            <div className="h-5 bg-surface-hairline dark:bg-surface-dark-hairline rounded w-1/3"></div>
            {[1, 2, 3].map(i => (
              <div key={i} className="h-3 bg-surface-hairline dark:bg-surface-dark-hairline rounded w-full"></div>
            ))}
          </div>
        </div>
      </Card>
